...
namespace EventProject.Repository.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server=KDK-403-PC13-YZ;Database=EventDB;Trusted_Connection=True;");
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Event>()
                ...
                .WithOne(e => e.Event)
                .HasForeignKey<EventDetail>(e => e.EventDetailId);

            modelBuilder.Entity<Ticket>()
                .HasKey(e => new { e.EventId, e.CustomerId }); //composite key
